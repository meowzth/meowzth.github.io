...
* **Python.** Программирую 3 года, джуниор. Использовал многие API, писал ботов для Telegram, ручки на Flask, скрипты на Bash и как-то даже трогал Jinja. Использую питон для анализа данных, могу нагуглить код для решения типичной задачи ML или собрать ETL процесс. До сих пор прошёл только первую сотню алгоритмов на LeetCode.
